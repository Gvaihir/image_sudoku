...
parser.add_argument('-o', default=os.path.join(os.getcwd(), 'model'), help='output dir. Default - WD/model')
...
X = sorted(glob(os.path.join(argsP.img, '*.tif')))
Y = sorted(glob(os.path.join(argsP.mask, '*.tif')))
